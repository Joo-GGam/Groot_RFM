...
class LeRobotSingleDataset(Dataset):
    ...
    def _get_metadata(self, embodiment_tag: EmbodimentTag) -> DatasetMetadata:
        ...
        dataset_statistics = {}
        for our_modality in ["state", "action", "force"]:
            if our_modality not in simplified_modality_meta or not simplified_modality_meta[our_modality]:
                continue
    ...
    def get_data_by_modality(
        ...
        elif modality == "state" or modality == "action" or modality == "force":
