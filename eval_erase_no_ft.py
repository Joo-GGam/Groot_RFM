#!/usr/bin/env python3
"""
Evaluate Erase Task Model - WITHOUT Force/Torque (NO F/T)

Model: erase_task_no_ft (trained WITHOUT F/T sensor data)

Usage:
    source ~/miniconda3/etc/profile.d/conda.sh && conda activate isaaclab
    python eval_erase_no_ft.py --plot --trajs 5
"""
...
@dataclass
class ArgsConfig:
    """Configuration for NO F/T model evaluation."""

    model_path: str = "/home/Isaac/Isaac-GR00T/output/erase_task_no_ft"
    """Path to the model (NO F/T)."""

    dataset_path: str = "/home/Isaac/Isaac-GR00T/datasets/Erase_for_gr00t"
    """Path to the dataset."""

    data_config: str = "rh20t_franka_no_ft"
    """Data config (NO F/T)."""
    ...
    save_plot_path: str = "/home/Isaac/Isaac-GR00T/Images/erase_no_ft.png"
    """Save path."""


def main(args: ArgsConfig):
    print("=" * 80)
    print("Erase Task Evaluation - NO F/T Model")
    print("=" * 80)
